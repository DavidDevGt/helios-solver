...
[private security advisory](../../security/advisories/new) on GitHub (the
same private channel used for vulnerability reports, see `SECURITY.md`), or
by contacting the maintainer directly through their GitHub profile. All
